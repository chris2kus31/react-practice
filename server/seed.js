...
import Listing from './services/listings/listings.model.js'
import ListingService from './services/listingServices/listingServices.model.js'
import Field from './services/fields/fields.model.js'
...
export const populate = async () => {
  ...
  try {
    const listingsWithListingService = await addListingServiceToListing(listingsData, listingServices)
...
const seed = async () => {
  try {
    ...
    console.log('the db uri is', DB_URI)
